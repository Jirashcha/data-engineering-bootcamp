...
def upload_blob(bucket_name, source_file_name, destination_blob_name):
    ...
    keyfile = "/workspaces/data-engineering-bootcamp/03-data-lake-with-google-cloud-storage/examples/uploading-to-gcs/dataworkshopday2-deb3-uploading-files-to-gcs-f9233f86727d.json"
